...
const ComboCard = ({
  ...
  return (
    <div className="group bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden hover:-translate-y-1 h-[450px] sm:h-[420px] md:h-[450px] flex flex-col">
