              ...
              <div>
                <div className="flex items-center space-x-4 mb-4">
                  <div className="w-16 h-16 gradient-gold rounded-2xl flex items-center justify-center">
                    <FaGenderless className="text-charcoal text-2xl" />
                  </div>
                  <div>
                    <span className="text-gold font-medium tracking-wider text-sm uppercase block">Unisex Perfumes</span>
                    <h1 className="text-4xl font-bold text-charcoal">Perfumes for Everyone</h1>
                  </div>
                </div>
                <p className="text-charcoal-light text-lg max-w-2xl">Great perfumes that work for both men and women, perfect for anyone who loves quality scents.</p>
              </div>
