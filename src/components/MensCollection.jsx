              ...
              <div>
                <div className="flex items-center space-x-3 sm:space-x-4 mb-4">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 gradient-gold rounded-2xl flex items-center justify-center">
                    <FaMars className="text-charcoal text-xl sm:text-2xl" />
                  </div>
                  <div>
                    <span className="text-gold font-medium tracking-wider text-xs sm:text-sm uppercase block">Men's Perfumes</span>
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold">Perfumes for Men</h1>
                  </div>
                </div>
                <p className="text-beige text-sm sm:text-base lg:text-lg max-w-2xl">Great perfumes designed for men who want to smell amazing and make a lasting impression.</p>
              </div>
